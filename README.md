...
PunchCard uses a memory model similar to that of [Brhttps://github.com/jhartwell/PunchCard/blob/master/README.mdainfuck](http://en.wikipedia.org/wiki/Brainfuck). The default memory layout is an array of
